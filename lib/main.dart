...
class _GamePageState extends State<GamePage> {
  ...
  GameStaus gameStatus = GameStaus.none;

  int index1 = 0, index2 = 0, diceSum = 2, target = 0;
  String result = '';
        ...
        child: shouldShowBoard
            ? Column(
                ...
                children: [
                  ...
                  if (gameStatus == GameStaus.running)
                  DiceButton(
